...
# Aufruf:   docker buildx bake [alpine|azul]
...
target "default" {
  tags = ["docker.io/juergenzimmermann/garten:2025.4.1-eclipse-noble"]
  #dockerfile = "Dockerfile"
  # context = "."
}

target "alpine" {
  tags = ["docker.io/juergenzimmermann/garten:2025.4.1-eclipse-alpine"]
  dockerfile = "Dockerfile.alpine"
}

target "azul" {
  tags = ["docker.io/kenanseke/garten:2025.4.1-azul"]
