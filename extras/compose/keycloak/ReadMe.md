...
Im Verzeichnis `extras\compose\keycloak` in der Datei `.env` sind der temporäre
Administrator mit Benutzername und Passwort konfiguriert, und zwar Benutzername
`tmp` und Passwort `p`.
    ...
    Menüpunkt "Clients"
        ...
        <Next>
            ...
            Valid redirect URIs     https://localhost:8080
                                    ...
                                    https://kunde:8080                      Microservice als Docker Container
                                    https://bestellung:8080                 2. Microservice als Docker Container
                                    https://oauth.pstmn.io/v1/callback      für Postman

                                    http://<microservice>:8080              falls Kubernetes die Microservices genutzt wird
        <Save>
...
Die zugehörige Basis-URL `http://localhost:8880/realms/spring` wird für Gradle in
...
- Als URI `http://localhost:8880/realms/spring/protocol/openid-connect/token` verwenden
