...
# Aufruf:   docker build --tag juergenzimmermann/garten:2025.4.1-eclipse-noble .
#               ggf. --progress=plain
#               ggf. --no-cache
#           Get-Content Dockerfile | docker run --rm --interactive hadolint/hadolint:2.12.1-beta-debian
#           docker save juergenzimmermann/garten:2025.4.1-eclipse-noble > garten.tar
...
LABEL org.opencontainers.image.title="garten" \
      org.opencontainers.image.description="Microservice garten v1 mit Basis-Image Eclipse Temurin und Ubuntu Noble" \
...
ENTRYPOINT ["java", "--enable-preview", "-classpath", "application.jar:lib/*:.", "com.acme.garten.Application"]
