...
val javaVersionSweeney = project.properties["javaVersionSweeney"] ?: libs.versions.javaVersionSweeney.get()
...
plugins {
    ...
    // TODO Gradle 9 https://sonarsource.atlassian.net/browse/SCANGRADLE-135
    ...
    // TODO Gradle 10: https://github.com/asciidoctor/asciidoctor-gradle-plugin/issues/751
...
sweeney {
    enforce(mapOf("type" to "gradle", "expect" to "[8.14.2,8.14.2]"))
    enforce(mapOf("type" to "jdk", "expect" to "[24.0.1,24.0.1]"))
    validate()
}
...
tasks.named("bootBuildImage", org.springframework.boot.gradle.tasks.bundling.BootBuildImage::class.java) {
    ...
    // default ab Spring Boot 3.5: "paketobuildpacks/builder-noble-java-tiny:latest" ohne Shell
